              ...
              <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
                ...
                <div className="space-y-6">
                  ...
                  <div className="p-4 bg-muted/30 rounded-lg">
                    <h4 className="font-semibold text-sm mb-3">User Statistics</h4>
                    <div className="grid grid-cols-2 gap-3 text-sm">
                      <div>
                        <span className="text-muted-foreground">Properties Created:</span>
                        <span className="ml-1 font-medium">{user._count.createdProperties}</span>
                      </div>
                      <div>
                        <span className="text-muted-foreground">Documents:</span>
                        <span className="ml-1 font-medium">{user._count.createdDocuments}</span>
                      </div>
                      <div>
                        <span className="text-muted-foreground">Releases:</span>
                        <span className="ml-1 font-medium">{user._count.releases}</span>
                      </div>
                      <div>
                        <span className="text-muted-foreground">Audit Logs:</span>
                        <span className="ml-1 font-medium">{user._count.auditLogs}</span>
                      </div>
                    </div>
                  </div>
                </div>
