// app/(dashboard)/[businessUnitId]/roles/create/page.tsx
...
import { Shield, Plus, Home } from 'lucide-react';
    ...
    <div className="container mx-auto py-6">
      ...
      <div className="mb-8">
        ...
        <p className="text-muted-foreground mt-2">
          Create a new role with specific permissions for your business unit
        </p>
      </div>

      {/* Form Component */}
      <RoleForm businessUnitId={businessUnitId} />
    </div>
  );
}